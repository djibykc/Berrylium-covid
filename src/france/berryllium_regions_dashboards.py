        ...
        fig.update_layout(
            ...
            annotations = [
                        dict(
                            ...
                            xref='paper',
                            yref='paper',
                            text="Moyenne mobile 7 jours. Données Santé publique France. Auteurs @eorphelin @Djiby CASSE & Alpha SOW - berryllium.</b>.", #'Date : {}. Source : Santé publique France. Auteur : #Djiby CASSE.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),
                            showarrow = False
                        ),
