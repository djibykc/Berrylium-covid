...
fig.update_layout(
    ...
    annotations = [
                dict(
                    ...
                    xref='paper',
                    yref='paper',
                    text='Date : 21/02/21. Données : Santé publique France. Auteur : @berryllium.',
                    showarrow = False
                )]
)

fig.write_image(PATH + "dashboards/charts/france/proportion_variants.jpeg", scale=2, width=900, height=500)
"""
...
fig.write_image(PATH + "dashboards/charts/france/points_deces.jpeg", scale=4, width=800, height=350)
...
fig.write_image(PATH + "dashboards/charts/france/immunite.jpeg", scale=2, width=800, height=2000)
...
name_fig = "var_journ"
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=2, width=1400, height=800)
...
plotly.offline.plot(fig, filename = PATH + 'dashboards/html_exports/france/{}.html'.format(name_fig), auto_open=False)
print("> " + name_fig)
if show_charts:
    fig.show()
...
for (range_x, name_fig) in [(["2020-03-22", last_day_plot], "var_journ_lines")]: #(["2020-06-10", last_day_plot], "var_journ_lines_recent")
    ...
    fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=2, width=1300, height=850)
...
for i in ("", "log"):
    ...
    fig.update_layout(
        ...
        annotations = [
                    dict(
                        ...
                        yref='paper',
                        font=dict(size=14),
                        text="<b>@Djiby CASSE - berryllium.</b>", #'Date : {}. Source : Santé publique France. Auteur : GRZ - berryllium.fr'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    
                        showarrow = False
                    ),
                    ]
                   )
    ...
    fig['layout']['annotations'] += (dict(
           ...
           dict(
            ...
            xref='paper',
            yref='paper',
            text="Données Santé publique France",#'Date : {}. Source : Santé publique France. Auteur : @Djiby CASSE & Alpha SOW.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
            showarrow=False
                    ))

    fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig+i), scale=2, width=900, height=600)

    plotly.offline.plot(fig, filename = PATH + 'dashboards/html_exports/france/{}.html'.format(name_fig+i), auto_open=False)
    print("> " + name_fig)
    if show_charts:
        fig.show()"""
...
fig.update_layout(
    ...
    annotations = [
                dict(
                    ...
                    xref='paper',
                    yref='paper',
                    text='Date : {}. Source : Santé publique France. Auteur : GRZ - berryllium.fr'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                ),
                ]
                 )
...
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=2, width=900, height=600)
    ...
    fig.update_layout(
        ...
        annotations = [
                    dict(
                        ...
                        xref='paper',
                        yref='paper',
                        text="<b>@Djiby CASSE - berryllium.</b>",#'Date : {}. Source : Santé publique France. Auteur : @Djiby CASSE & Alpha SOW.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                    ),
    ...
    fig.update_layout(
        ...
        annotations = [
                    dict(
                        ...
                        xref='paper',
                        yref='paper',
                        text="<b>@Djiby CASSE - berryllium.</b>", #'Date : {}. Source : Santé publique France. Auteur : @Djiby CASSE & Alpha SOW.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    
                        showarrow = False
                    ),
...
for i in [""]:
    ...
    fig.update_layout(
        ...
        annotations = [
                    dict(
                        ...
                        xref='paper',
                        yref='paper',
                        text="Moyenne mobile de 7 jours. Données Santé publique France. Auteurs @Djiby CASSE - berryllium. <b>.fr</b>.", #'Date : {}. Source : Santé publique France. Auteur : @Djiby CASSE & Alpha SOW.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),
                        showarrow = False
                    ),
    ...
    fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig+i), scale=2, width=1100, height=600)
            ...
            fig.update_layout(
                ...
                annotations = [
                            ...
                            dict(
                                ...
                                yref='paper',
                                font=dict(size=14),
                                text="Par date de remontée du résultat de test - @Djiby CASSE - berryllium.",#'Date : {}. Source : Santé publique France. Auteur : GRZ - berryllium.fr.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                                showarrow=False
                            ),
                            ]
                             )
...
fig.update_layout(
    annotations=[dict(
                            ...
                            yref='paper',
                            font=dict(size=14),
                            text="Par date de prélèvement sur le patient - @Djiby CASSE - berryllium.",#'Date : {}. Source : Santé publique France. Auteur : GRZ - berryllium.fr.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                            showarrow=False
                        ),],
    title={
...
for croiss in ["", "_croissance", "log"]:
    im1 = cv2.imread(PATH + 'dashboards/charts/france/cas_journ{}.jpeg'.format(croiss))
    im2 = cv2.imread(PATH + 'dashboards/charts/france/hosp_journ{}.jpeg'.format(croiss))
    im3 = cv2.imread(PATH + 'dashboards/charts/france/rea_journ{}.jpeg'.format(croiss))
    im4 = cv2.imread(PATH + 'dashboards/charts/france/dc_journ{}.jpeg'.format(croiss))

    #im_haut = cv2.hconcat([im1, im2])
    #cv2.imwrite('dashboards/charts/france/tests_combinaison.jpeg', im_h)
    #im_bas = cv2.hconcat([im3, im4])

    #im_totale = cv2.vconcat([im_haut, im_bas])
   # cv2.imwrite(PATH + 'dashboards/charts/france/dashboard_jour{}.jpeg'.format(croiss), im_totale)
...
fig1 = sg.fromfile(PATH+'dashboards/charts/france/cas_journ.svg')
fig2 = sg.fromfile(PATH+'dashboards/charts/france/hosp_journ.svg')
fig3 = sg.fromfile(PATH+'dashboards/charts/france/rea_journ.svg')
fig4 = sg.fromfile(PATH+'dashboards/charts/france/dc_journ.svg')
...
fig.save(PATH+"dashboards/charts/france/dashboard_jour.svg")"""
    ...
    fig.update_layout(
        ...
        annotations = [dict(
                    ...
                    dict(
                        ...
                        xref='paper',
                        yref='paper',
                        text='Date : {}. Source : Santé publique France. berryllium.fr.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                    ),
                    ]
                     )
    ...
    fig.update_layout(
        ...
        annotations = [
                    ...
                    dict(
                        ...
                        xref='paper',
                        yref='paper',
                        text='Date : {}. Source : Santé publique France. Auteur : berryllium.fr'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                    ),
                    ]
                     )
...
fig.update_layout(
    ...
    annotations = [
                dict(
                    ...
                    xref='paper',
                    yref='paper',
                    text='Date : {}. Source : INSEE et CSSE. Auteur : @Djiby CASSE & Alpha SOW.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                )]
                 )

name_fig = "evol_journ"
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=1.5, width=900, height=800)
...
fig.update_layout(
    ...
    annotations = [
                ...
                dict(
                    ...
                    xref='paper',
                    yref='paper',
                    text='Date : {}. Source : INSEE et CSSE. Auteur : @Djiby CASSE & Alpha SOW'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),           
                    showarrow = False)
                ]
                )

name_fig = "entrees_sorties_hosp_rea"
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=2, width=1200, height=800)
        ...
        fig.update_layout(
            ...
            annotations = [
                        ...
                        dict(
                            ...
                            xref='paper',
                            yref='paper',
                            text='Date : {}. Source : Santé publique France et CSSE. Auteur : GRZ - berryllium.fr'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),           
                            showarrow = False)
                        ]
                        )
...
name_fig = "hosp_bar"
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=3, width=1400, height=800)
...
for (data_type, data_type_title, marker_color, fillcolor, descr) in [("hosp", "Nombre de personnes hospitalisées pour", "rgb(209, 102, 21)", "rgba(209, 102, 21,0.3)", ""), 
    ...
    fig.add_annotation(
                    dict(
                        ...
                        xanchor='center',
                        yanchor='middle',
                        text='{} - @Djiby CASSE - berryllium. - {}'.format(descr, datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),
                        showarrow = False,
                        font=dict(size=15), 
                        opacity=0.8
                    ))
    ...
    fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=3, width=1400, height=600)
    plotly.offline.plot(fig, filename = PATH + 'dashboards/html_exports/france/{}.html'.format(name_fig), auto_open=False)
    print("> " + name_fig)
...
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=2, width=1100, height=1200)
...
commentaire = "Les points rouges représentent les données brutes quotidiennes. Les lignes rouges sont obtenues en effectuant la moyenne mobile<br>centrée, sur 7 jours. Source : Santé publique France. Auteur : GRZ - <i>berryllium.fr - {}</i>".format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y'))
fig["layout"]["annotations"] += ( dict(
                        x=0.5,
                        y=-0.05,
                        xref='paper',
                        ...
                        yanchor='middle',
                        text="",
                        #text='@Djiby CASSE & Alpha SOW - {}'.format(datetime.strptime(max(dates_sursaud), '%Y-%m-%d').strftime('%d %B %Y')),
                        showarrow = False,
                        font=dict(size=15), 
                        opacity=0.8
                    ),
...
fig.add_layout_image(
        dict(
            source="data/berryllium_logo.jpeg",
...
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=2, width=1100, height=1400)
...
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=2, width=1700, height=2300)
...
commentaire = "Les points rouges représentent les données brutes quotidiennes. Les lignes rouges sont obtenues en effectuant la moyenne mobile<br>centrée, sur 7 jours. <i>@Djiby CASSE - berryllium. - {}</i>".format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y'))
fig["layout"]["annotations"] += (
                    dict(
                        x=0.5,
                        y=1.5,
...
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=2, width=3400, height=300)
#fig.show()
...
fig.update_layout(
    ...
    annotations = [
                dict(
                    ...
                    yref='paper',
                    opacity=0.8,
                    text='Date : {}. Source : Santé publique France. Auteur : @Djiby CASSE - berryllium.'.format(datetime.strptime(dates[-1], '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                )]
                 )
...
name_fig = "reffectif"
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=3, width=900, height=550)
...
for (name, array, title, scale_txt, data_example, digits) in [("cas", array_positif, "Nombre de <b>tests positifs</b>", "", "", 0), ("taux", array_taux, "Taux de <b>positivité</b>", "%", "%", 1), ("incidence", array_incidence, "Taux d'<b>incidence</b>", " cas", " cas", 1)]: #
    ...
    annots = annot + [
                    dict(
                        ...
                        text='Lecture : une case correspond au {} pour une tranche d\'âge (à lire à droite) et à une date donnée (à lire en bas).<br>Du rouge correspond à un {} élevé.  <i>Date : {} - Source : <b>@Djiby CASSE - berryllium.</b> berryllium.fr - Données : Santé publique France</i>'.format(title.lower().replace("<br>", " "), title.lower().replace("<br>", " "), now.strftime('%d %B')),
                        showarrow = False
                    ),
                ]
    ...
    fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=3, width=1300, height=550)
    #fig.show()
    plotly.offline.plot(fig, filename = PATH + 'dashboards/html_exports/france/{}.html'.format(name_fig), auto_open=False)
    ...
    fig.update_layout(
        ...
        annotations = annot + [
                    dict(
                        ...
                        text='Lecture : une case correspond au {} pour une tranche d\'âge (à lire à gauche) et à une date donnée (à lire en bas).<br>Du orange correspond à un {} élevé.  <i>Date : {} - Source : berryllium.fr - Données : Santé publique France</i>'.format(title.lower().replace("<br>", " "), title.lower().replace("<br>", " "), now.strftime('%d %B')),
                        showarrow = False
                    ),
                ],
    margin=dict(
...
fig["layout"]["annotations"] += (
                dict(
                    ...
                    yref='paper',
                    font=dict(size=9),
                    text='Date : {}. Source : Santé publique France et DREES. Auteur : @Djiby CASSE - berryllium.'.format(datetime.strptime(dates[-1], '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                ),)
            

name_fig = "indic2_france"
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=2, width=1100, height=700)
...
fig["layout"]["annotations"] += ( dict(
                        ...
                        xanchor='center',
                        yanchor='middle',
                        text='Source : Santé publique France - berryllium.fr - {}'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),
                        showarrow = False,
                        font=dict(size=15), 
                        opacity=0.8
                    ),)
...
fig["layout"]["annotations"] += ( dict(
                        ...
                        yref='paper',
                        xanchor='center',
                        text='moyenne mobile centrée sur 7 jours pour lisser les week-ends - Données Santé publique France - berryllium.fr',
                        font=dict(size=15),
                        showarrow = False),)

fig.add_layout_image(
        dict(
            source="https://raw.githubusercontent.com/berryllium./master/dashboards/berryllium_logo_text.jpeg",
            xref="paper", yref="paper",
            x=1.15, y=1.1,
...
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=3, width=1100, height=700)
        ...
        title={
            ...
            annotations = [
                    ...
                    dict(
                        ...
                        xref='paper',
                        yref='paper',
                        text='Date : {}. Source : Santé publique France. Auteur : berryllium.fr.'.format(datetime.strptime(dates[-1], '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                    )]
                     )
    fig.update_xaxes(range=[dates[-90], last_day_plot], nticks=20, tickformat="%d %b")

    name_fig = "cas_reg" + graph
    fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=3, width=1100, height=1000)
...
for (dataset, column, dates_to_use, title, folder) in [    (df_incid_reg, "incidence_rolling", dates_incid, "Incidence", "course_incidence"),    (df_incid_reg, "P_rolling", dates_incid, "Cas de Covid19", "course_cas"),    (df_region, "dc_pop_new_rolling", dates, "Décès hosp. quotidiens pour 10M hab.", "course_dc")]:
        ...
        for i in range(-n1, 0):   
            ...
            fig.update_layout(
                ...
                annotations = [
                        dict(
                            ...
                            yref='paper',
                            font=dict(size=11),
                            text='Données : Santé publique France. Auteur : @Djiby CASSE - berryllium.',
                            showarrow = False
                        )],
            ...
            fig.write_image(PATH + "dashboards/charts/france/{}/{}.jpeg".format(folder, i), scale=2, width=650, height=450)
...
"""
i=0
with imageio.get_writer(PATH + "dashboards/charts/france/course_incidence/course.gif", mode='I', duration=0.2) as writer: 
    for i in range(-n, 0):
        image = imageio.imread((PATH + "dashboards/charts/france/course_incidence/{}.jpeg").format(i))
...
for (folder, n, fps) in [("course_rea_clage_rolling", n2, 7), ("course_hosp_clage_rolling", n2, 7), ("course_incidence", n1, 5), ("course_dc", n1, 5), ("course_cas", n1, 5),]:
    img_array = []
    for i in range(-n, 0):
        img = cv2.imread((PATH + "dashboards/charts/france/{}/{}.jpeg").format(folder, i))
    ...
    out = cv2.VideoWriter(PATH + 'dashboards/charts/france/{}/course.mp4'.format(folder),cv2.VideoWriter_fourcc(*'MP4V'), fps, size)
    ...
    try:
        import subprocess
        subprocess.run(["ffmpeg", "-y", "-i", PATH + "dashboards/charts/france/{}/course.mp4".format(folder), PATH + "dashboards/charts/france/{}/course_opti.mp4".format(folder)])
        subprocess.run(["rm", PATH + "dashboards/charts/france/{}/course.mp4".format(folder)])

        #subprocess.run(["rm", 'dashboards/charts/france/{}/course265.mp4'.format(folder)])
        #subprocess.run(["ffmpeg", "-i", 'dashboards/charts/france/{}/course.mp4'.format(folder), "-b", "1000k" \
         #               'dashboards/charts/france/{}/course265.webm'.format(folder)])
        #subprocess.run(["ffmpeg", "-i", 'dashboards/cdoharts/france/{}/course.mp4'.format(folder), "-vcodec", "libx265", "-crf", "28", \
                        #'dashboards/charts/france/{}/course265.webm'.format(folder)])
            #ffmpeg -i dashboards/charts/france/course_rea_clage_rolling/course.mp4 -vcodec libvpx-vp9 -b:v 1M -acodec libvorbis output.webm
...
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=3, width=1000, height=700)
...
plotly.offline.plot(fig, filename = PATH + 'dashboards/html_exports/france/{}.html'.format(name_fig), auto_open=False, config={"displayModeBar": False})
print("> " + name_fig)
if show_charts:
    fig.show()
...
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=3, width=1100, height=500)
...
fig.write_image(PATH + "dashboards/charts/france/{}.jpeg".format(name_fig), scale=3, width=1300, height=600)
    ...
    xaxis_title="",
        annotations = [
                dict(
                    ...
                    xref='paper',
                    yref='paper',
                    text='Date : {}. Source : Santé publique France, INSEE et CSSE. Auteur : @Djiby CASSE & Alpha SOW'.format(datetime.strptime(dates[-1], '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                )]
                 )
...
fig.update_layout(
            ...
            annotations = [
                dict(
                    ...
                    xref='paper',
                    yref='paper',
                    text='Date : {}. Source : INSEE et CSSE. Auteur : Djiby CASSE & Alpha SOW.'.format(datetime.strptime(dates[-1], '%Y-%m-%d').strftime('%d %B %Y')),
                    showarrow = False
                )]
)
