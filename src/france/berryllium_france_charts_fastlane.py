        ...
        fig.update_layout(
            ...
            annotations = [
                        dict(
                            ...
                            yref='paper',
                            font=dict(size=14),
                            text="",#'Date : {}. Source : Santé publique France. Auteur : @Djiby CASSE & Apha SOW - Berryllium.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                            showarrow=False
                        ),
                        dict(
                            x=0.5,
                            ...
                            yref='paper',
                            font=dict(size=14),
                            text="Par date de prélèvement sur le patient - @Djiby CASSE & Apha SOW - Berryllium.",#'Date : {}. Source : Santé publique France. Auteur : @Djiby CASSE & Apha SOW - Berryllium.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                            showarrow=False
                        ),
                        ]
                         )
        ...
        fig['layout']['annotations'] += (
            dict(
             ...
             dict(
                ...
                xref='paper',
                yref='paper',
                text="Données Santé publique France",#'Date : {}. Source : Santé publique France. Auteur : @Djiby CASSE & Apha SOW - Berryllium.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                showarrow=False
                        ))
    ...
    fig.update_layout(
        ...
        annotations = [
                    dict(
                        ...
                        xref='paper',
                        yref='paper',
                        text="<b>@Djiby CASSE & Apha SOW - Berryllium.</b>",#'Date : {}. Source : Santé publique France. Auteur : @Djiby CASSE & Apha SOW - Berryllium.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                    ),
    ...
    fig.update_layout(
        ...
        annotations = [
                    dict(
                        ...
                        xref='paper',
                        yref='paper',
                        text="<b>@Djiby CASSE & Apha SOW - Berryllium. </b>", #'Date : {}. Source : Santé publique France. Auteur : @Djiby CASSE & Apha SOW - Berryllium.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),
                        showarrow = False
                    ),
    ...
    fig.update_layout(
        ...
        annotations = [
                    dict(
                        ...
                        yref='paper',
                        font=dict(size=14),
                        text="<b>@Djiby CASSE & Apha SOW - Berryllium.</b>", #'Date : {}. Source : Santé publique France. Auteur : @Djiby CASSE & Apha SOW - Berryllium.personne .format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),
                        showarrow = False
                    ),
                    ]
                   )
        ...
        fig.update_layout(
            ...
            annotations = [
                        ...
                        dict(
                            ...
                            yref='paper',
                            font=dict(size=14),
                            text="Par date de remontée du résultat de test - @Djiby CASSE & Apha SOW - Berryllium.",#'Date : {}. Source : Santé publique France. Auteur : @Djiby CASSE & Apha SOW - Berryllium.'.format(datetime.strptime(max(dates), '%Y-%m-%d').strftime('%d %B %Y')),                    showarrow = False
                            showarrow=False
                        ),
                        ]
                         )
